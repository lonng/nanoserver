...
func (wc *wechat) CreateOrderResponse(order *model.Order) (interface{}, error) {
	...
	if xmlResp.Return_code == fail {
		...
		return nil, errutil.YXErrRequestPrePayIDFailed
	}
...
func (wc *wechat) Notify(request interface{}) (*model.Trade, interface{}, error) {
...
func init() {
	yxsdk.Register(types.Wechat, &wechat{})
}
