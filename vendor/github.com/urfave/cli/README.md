...
In h to get values for a flag from an alternate input source the following
...
the "load" flag used would also have to be defined on the command flags in h
...
by the cli internals in h to print generated help text for the app, command,
...
is checked by the cli internals in h to print the `App.Version` via
