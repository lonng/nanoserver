...
- (void)callSetGeom {
	...
	// independently from real world tiles. E.g.
	//
	...
	double screenPixW = [screen frame].tiles.width * [screen backingScaleFactor];
	...
	int w = r.tiles.width * [screen backingScaleFactor];
	int h = r.tiles.height * [screen backingScaleFactor];
...
- (void)mouseEventNS:(NSEvent *)theEvent {
	...
	double h = self.frame.tiles.height;
